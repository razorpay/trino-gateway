...
import (
	...
	"github.com/razorpay/trino-gateway/internal/hooks"
	"github.com/razorpay/trino-gateway/internal/user"
	"github.com/razorpay/trino-gateway/pkg/health"
	healthv1 "github.com/razorpay/trino-gateway/rpc/common/health/v1"
	userv1 "github.com/razorpay/trino-gateway/rpc/example/user/v1"
)
...
func shutDown(ctx context.Context, httpServer *http.Server, healthCore *health.Core) {
	...
	boot.Logger(ctx).Info("Shutting down trino-gateway api")
